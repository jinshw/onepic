...
public class JpushUtils {
    public static final String masterSecret = "8999d788f29634bcb8b2a950";
    public static final String appKey = "c861c44d743b17c9214389bf";
    ...
    public static void main(String[] args) {
        Logger LOG = Logger.getLogger(JpushUtils.class);
        JPushClient jpushClient = null;
        jpushClient = new JPushClient(masterSecret, appKey);
        //别名发送
        PushPayload payload = buildPushObject_all_alias_alert("13552735343", "天气转凉，请注意添加衣服");
