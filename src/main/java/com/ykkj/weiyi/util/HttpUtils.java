...
public class HttpUtils {
     ...
     */
    public static String URLPost(String url, Map<String, String> params, String enc, HttpServletRequest request) {
    ...
    public static String URLPostXML(String url, String sendXML, String enc) {
        ...
        try {
            postMethod = new PostMethod(url);
            postMethod.setRequestEntity(new StringRequestEntity(sendXML, "text/xml", enc));
    ...
    public static org.apache.commons.httpclient.Cookie getJESESSIONID(HttpServletRequest request) {
