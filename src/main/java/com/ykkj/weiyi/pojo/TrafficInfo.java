...
public class TrafficInfo {
    ...
    public String getFlowAffectlen() {
        return flowAffectlen;
    }

    public void setFlowAffectlen(String flowAffectlen) {
        this.flowAffectlen = flowAffectlen;
    }
