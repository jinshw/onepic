...
public interface SectInfoMapper {
    ...
    int updateByExampleSelective(@Param("record") SectInfoWithBLOBs record, @Param("example") SectInfoExample example);

    int updateByExampleWithBLOBs(@Param("record") SectInfoWithBLOBs record, @Param("example") SectInfoExample example);

    int updateByExample(@Param("record") SectInfo record, @Param("example") SectInfoExample example);
