...
public interface SupervisionInfoMapper
{
    ...
    List<SupervisionInfoWithBLOBs> selectByExampleWithBLOBs(
            SupervisionInfoExample example);
    ...
    int updateByExampleSelective(
            @Param("record") SupervisionInfoWithBLOBs record,
            @Param("example") SupervisionInfoExample example);

    int updateByExampleWithBLOBs(
            @Param("record") SupervisionInfoWithBLOBs record,
            @Param("example") SupervisionInfoExample example);

    int updateByExample(@Param("record") SupervisionInfo record,
            @Param("example") SupervisionInfoExample example);
