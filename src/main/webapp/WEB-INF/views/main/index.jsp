    ...
    <div id="page-wrapper">
        ...
        <div id="page-inner">
            <div class="row">
                ...
                <a href="${ctx}/hd/getPmsIssueInfoHDALL" target="_blank"
                   class="btn btn-primary">获取PMS_IMSSUE信息（全量接口）</a>
                ...
                <a href="${ctx}/hd/getPmsQingdanJiliangMainHDZL" target="_blank"
                   class="btn btn-primary">获取计量单主表信息（增量接口）</a>
                <a href="${ctx}/hd/getPmsQingdanJiliangHDALL" target="_blank"
                   class="btn btn-primary">获取计量单子表信息（全量接口）</a>
                <a href="${ctx}/hd/getPmsQingdanJiliangHDZL" target="_blank" class="btn btn-primary">获取计量单子表信息（增量接口）</a>
                <a href="${ctx}/hd/getPmsPlaninputZbInfoHDALL" target="_blank"
                   class="btn btn-primary">获取月报录入表信息（全量接口）</a>
                <a href="${ctx}/hd/test" target="_blank" class="btn btn-primary">测试接口</a>
                <br/>
                <a href="${ctx}/main/kafka" target="_blank" class="btn btn-primary">启动Kafka模拟服务</a>
                <a href="${ctx}/main/stopkafka" target="_blank" class="btn btn-primary">停止Kafka模拟服务</a>
