...
<div class="weui_cells weui_cells_form">
    ...
    <div class="weui_cell">
        ...
        <div class="weui_cell_bd weui_cell_primary">
            <input class="weui_input" id="patientList" name="patientList" type="text" value="" placeholder="请选择就诊人">
        </div>
    </div>
</div>
<div class="weui-row weui-no-gutter">
    ...
    <div class="div-bt">
        <div class="div-child-bt" id="notPayBt" style="border-bottom:2px solid #10ae63;">
            未支付
        </div>
        <div class="div-child-bt" id="alreadyPayBt">已支付</div>
    </div>
</div>
