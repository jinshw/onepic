define(function (require, exports, module) {
    ...
    BaseObject.Location.prototype = BaseHelper.Class.inherit(BaseObject.Component, {
        ...
        setLocation: function (target, config) {
            ...
            var isOverLayer = config.isOverLayer || true;
        ...
        _getTooltipText: function (feature, configData) {
            var innerHtml = "";
            var width = configData.width ||"100%";
                ...
                onEachFeature: function (feature, layer) {
                    ...
                    if (config.labelField) {
                        ...
                        function (e) {
                            ...
                            if (config.width) {
                                $(".leaflet-tooltip").css({ "white-space": "normal", "width": config.width})
                            }
                        });
                        layer.on("mouseout",
                        function (e) {
