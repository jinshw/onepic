...
var DragMixin = {
    ...
    _dragMixinOnMouseMove: function(t) {
        ...
        this._dragging || (this._dragging = !0, L.DomUtil.addClass(e, "leaflet-pm-dragging"), this._layer.bringToFront(), this._layer._map.dragging.disable(), this._markerGroup.clearLayers(), this._layer.fire("pm:dragstart")),
        this._onLayerDrag(t)
    },
    ...
    _onLayerDrag: function(t) {
        ...
        a = void 0;
        a = this._layer instanceof L.Polygon ? this._layer._latlngs[0] : this._layer._latlngs;
        ...
        this._layer.setLatLngs(n).redraw(),
...
OverlapMixin = {
    _applyPossibleCoordsChanges: function() {
        if (this._tempPolygon) {
            var t = this._tempPolygon.getLayers()[0].getLatLngs();
            this._poly.setLatLngs(t).redraw(),
            this._initMarkers()
        }
    },
    _drawTemporaryPolygon: function(t) {
        this._poly.setStyle({
            opacity: 0,
            fillOpacity: 0
        }),
        this._tempPolygon = L.geoJson(t).addTo(this._poly._map).bringToBack()
    },
    _handleOverlap: function() {
        var t = this._poly,
        e = this._layerGroup.getLayers(),
        i = !1,
        a = this._poly.toGeoJSON();
        e.filter(function(e) {
            return ! Object.is(e, t)
        }).map(function(t) {
            var e = void 0;
            try {
                e = turf.intersect(a, t.toGeoJSON())
            } catch(n) {
                console.warn("Turf Error.")
            }
            return e && (a = turf.difference(a, t.toGeoJSON()), "MultiPolygon" !== a.geometry.type && (i = !0)),
            !0
        }),
        this._tempPolygon && (this._tempPolygon.remove(), delete this._tempPolygon),
        i ? this._drawTemporaryPolygon(a) : this._poly.setStyle({
            opacity: 1,
            fillOpacity: .2
        })
    }
...
SnapMixin = {
    _initSnappableMarkers: function() {
        ...
        this._markers.forEach(function(e) {
            ...
            e.on("drag", t._handleSnapping, t),
            e.off("dragend", t._cleanupSnapping, t),
            e.on("dragend", t._cleanupSnapping, t)
        }),
    ...
    _handleSnapping: function(t) {
        ...
        return i.distance < r ? (e.setLatLng(n), e._snapped = !0, this._snapLatLng !== n && (this._snapLatLng = n, e.fire("pm:snap", s), this._layer.fire("pm:snap", s))) : this._snapLatLng && (this._unsnap(s), e._snapped = !1, s.marker.fire("pm:unsnap", s), this._layer.fire("pm:unsnap", s)),
        !0
    },
    _checkPrioritiySnapping: function(t) {
        ...
        a = t.segment[1],
        n = t.latlng,
        r = this._getDistance(e, i, n),
        s = this._getDistance(e, a, n),
        o = r < s ? i: a,
        l = r < s ? r: s,
    ...
    _createSnapList: function() {
        ...
        e = e.filter(function(t) {
            return t._latlng || t._latlngs.length > 0
        }),
        e = e.filter(function(t) {
    ...
    _calcClosestLayer: function(t, e) {
        ...
        return e.forEach(function(e, n) {
            var r = i._calcLayerDistances(t, e);
            i.debugIndicatorLines[n].setLatLngs([t, r.latlng]),
            (void 0 === a.distance || r.distance < a.distance) && (a = r, a.layer = e)
        }),
        a
    },
    _calcLayerDistances: function(t, e) {
        ...
        o = t,
        l = void 0;
        if (n) l = e.getLatLngs()[0];
        else if (r) l = e.getLatLngs();
        else if (s) return l = e.getLatLng(),
        {
            latlng: Object.assign({},
            l),
            distance: this._getDistance(a, l, o)
        };
        var h = void 0,
        _ = void 0;
        l.forEach(function(t, e) {
            var r = t,
            s = void 0;
            s = n ? e + 1 === l.length ? 0 : e + 1 : e + 1 === l.length ? void 0 : e + 1;
            var p = l[s];
            if (p) {
                var c = i._getDistanceToSegment(a, o, r, p); (void 0 === _ || c < _) && (_ = c, h = [r, p])
            }
            return ! 0
        });
        var p = this._getClosestPointOnSegment(a, t, h[0], h[1]);
        return {
            latlng: Object.assign({},
            p),
            segment: h,
    ...
    _getClosestPointOnSegment: function(t, e, i, a) {
        var n = t.getMaxZoom();
        n === 1 / 0 && (n = t.getZoom());
        var r = t.project(e, n),
        s = t.project(i, n),
        o = t.project(a, n),
        l = L.LineUtil.closestPointOnSegment(r, s, o);
        return t.unproject(l, n)
    },
    _getDistanceToSegment: function(t, e, i, a) {
        var n = t.latLngToLayerPoint(e),
        r = t.latLngToLayerPoint(i),
        s = t.latLngToLayerPoint(a);
        return L.LineUtil.pointToSegmentDistance(n, r, s)
    },
...
L.PM = L.PM || {
    ...
    addInitHooks: function() {
        ...
        L.Marker.addInitHook(e),
        L.Polygon.addInitHook(i),
        L.Polyline.addInitHook(a),
        L.Circle.addInitHook(n),
        L.Map.addInitHook(r)
    }
},
L.PM.initialize(),
L.PM.Map = L.Class.extend({
    initialize: function (t) {
        if (t.options.name == "overviewer") return;
        this.map = t,
    ...
    removeLayer: function(t) {
        var e = t.target;
        e._layers || e.pm.dragging() || t.target.remove()
    },
    ...
    toggleGlobalEditMode: function() {
        ...
        e = [];
        this.map.eachLayer(function(t) { (t instanceof L.Polyline || t instanceof L.Marker || t instanceof L.Circle) && e.push(t)
        }),
        e = e.filter(function(t) {
            return !! t.pm
        }),
        ...
        this.globalEditEnabled() ? (this._globalEditMode = !1, e.forEach(function(t) {
            t.pm.disable()
...
L.PM.Edit.Circle = L.PM.Edit.extend({
    ...
    _initMarkers: function() {
        ...
        a = this._getLatLngOnCircle(e, i);
        this._centerMarker = this._createCenterMarker(e),
        this._outerMarker = this._createOuterMarker(a),
    ...
    _createHintLine: function(t, e) {
        var i = t.getLatLng(),
        a = e.getLatLng();
        this._hintline = L.polyline([i, a], this.options.hintlineStyle),
        this._hintline._pmTempLayer = !0,
        this._layerGroup.addLayer(this._hintline)
    },
    _createCenterMarker: function(t) {
        var e = this._createMarker(t);
        return e.on("move", this._moveCircle, this),
        e
    },
    _createOuterMarker: function(t) {
        var e = this._createMarker(t);
        return e.on("move", this._resizeCircle, this),
        e
    },
    _createMarker: function(t) {
        var e = new L.Marker(t, {
...
L.PM.Edit.LayerGroup = L.Class.extend({
    ...
    dragging: function e() {
        var e = this._layers.find(function(t) {
...
L.PM.Edit.Line = L.PM.Edit.extend({
    ...
    enable: function() {
        ...
        this.options = e,
        this._map = this._layer._map,
        this._map && (this.enabled() || this.disable(), this._enabled = !0, this._initMarkers(), this._layer.on("remove",
        function(e) {
            t.disable(e.target)
    ...
    _initMarkers: function() {
        ...
        var e = this._layer._latlngs;
        this._markers = e.map(this._createMarker, this);
        for (var i = 0; i < e.length - 1; i += 1) {
            var a = i + 1;
            this._createMiddleMarker(this._markers[i], this._markers[a])
        }
        this.options.snappable && this._initSnappableMarkers()
    },
    _createMarker: function(t, e) {
        ...
        i.on("contextmenu", this._removeMarker, this),
        this._markerGroup.addLayer(i),
        i
    },
    _createMiddleMarker: function(t, e) {
        var i = this,
        a = this._calcMiddleLatLng(t.getLatLng(), e.getLatLng()),
        n = this._createMarker(a),
        r = L.divIcon({
    ...
    _addMarker: function(t, e, i) {
        ...
        n.splice(r, 0, a),
        t._origLatLng = n[r],
        this._markers.splice(r, 0, t),
        this._markers.map(function(t, e) {
            return t._index = e,
            !0
        }),
    ...
    _removeMarker: function(t) {
        ...
        if (void 0 !== a) {
            i.splice(a, 1),
            i.length < 1 ? this._layer.remove() : this._layer.redraw(),
            ...
            var n = a - 1 < 0 ? void 0 : a - 1,
            r = a + 1 >= this._markers.length ? void 0 : a + 1;
            if (r && n && r !== n) {
                var s = this._markers[n],
                o = this._markers[r];
    ...
    _onMarkerDrag: function(t) {
        var e = t.target;
        if (void 0 !== e._index) {
            var i = e._index + 1 >= this._markers.length ? 0 : e._index + 1,
            a = e._index - 1 < 0 ? this._markers.length - 1 : e._index - 1;
            L.extend(e._origLatLng, e._latlng),
            this._layer.redraw();
            var n = e.getLatLng(),
            r = this._markers[a].getLatLng(),
            s = this._markers[i].getLatLng();
            if (e._middleMarkerNext) {
                var o = this._calcMiddleLatLng(n, s);
                e._middleMarkerNext.setLatLng(o)
            }
            if (e._middleMarkerPrev) {
                var l = this._calcMiddleLatLng(n, r);
                e._middleMarkerPrev.setLatLng(l)
            }
        }
    },
    ...
    _calcMiddleLatLng: function(t, e) {
        ...
        a = i.project(t),
        n = i.project(e),
        r = i.unproject(a._add(n)._divideBy(2));
        return r
    }
}),
L.PM.Edit.Marker = L.PM.Edit.extend({
    ...
    enable: function() {
        ...
        this.options = t,
        this._map = this._layer._map,
        this.enabled() || (this._enabled = !0, this._layer.on("contextmenu", this._removeMarker, this), this.options.snappable && this._layer.dragging.enable(), this.options.snappable && this._initSnappableMarkers())
    },
    enabled: function() {
        return this._enabled
    },
...
L.PM.Edit.Poly = L.PM.Edit.Line.extend({
    _initMarkers: function() {
        ...
        this._markerGroup = new L.LayerGroup,
        t.addLayer(this._markerGroup);
        var e = this._layer._latlngs[0];
        this._markers = e.map(this._createMarker, this);
        for (var i = 0; i < e.length; i += 1) {
            var a = i + 1 >= e.length ? 0 : i + 1;
            this._createMiddleMarker(this._markers[i], this._markers[a])
        }
        this.options.snappable && this._initSnappableMarkers()
    },
...
L.Control.PMButton = L.Control.extend({
    ...
    toggle: function(t) {
        return "boolean" == typeof t ? this._button.toggleStatus = t: this._button.toggleStatus = !this._button.toggleStatus,
    ...
    _makeButton: function(t) {
        ...
        var a = L.DomUtil.create("div", "control-icon", i);
        return t.iconUrl && a.setAttribute("src", t.iconUrl),
        t.className && L.DomUtil.addClass(a, t.className),
        L.DomEvent.addListener(i, "click",
        function() {
...
L.PM.Toolbar = L.Class.extend({
    ...
    toggleControls: function() {
        this.isVisible ? this.removeControls() : this.addControls()
    },
    ...
    toggleButton: function(t, e) {
        return this.triggerClickOnToggledButtons(this.buttons[t]),
    ...
    _defineButtons: function() {
        ...
        this._addButton("drawMarker", new L.Control.PMButton(a)),
        ...
        this._addButton("editPolygon", new L.Control.PMButton(s)),
        this._addButton("dragPolygon", new L.Control.PMButton(o)),
        this._addButton("deleteLayer", new L.Control.PMButton(e))
    },
