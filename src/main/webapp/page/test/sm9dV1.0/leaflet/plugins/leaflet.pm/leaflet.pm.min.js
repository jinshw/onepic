...
L.PM.Draw = L.Class.extend({
    ...
    active: function (url, t) {
        var thisCallBack = this;
        if (thisCallBack[t]) {
            thisCallBack[t].active();
        }
        else {
            //加载所有图层数据
            seajs.use(BaseObject.path + "/" + url,
            function (a) {
                var instance = new a(globalMap);
                thisCallBack[t] = instance;
                $("#button123").append(instance.getHtml());
...
L.PM.Edit.LayerGroup = L.Class.extend({
    ...
    enabled: function t() {
        if (this._layers.hasOwnProperty('find')) {
...
L.Control.PMButton = L.Control.extend({
    ...
    initialize: function (t, map) {
        this._button = L.Util.setOptions(this, t);
        this._map = map;
    },

    active: function (e) {
        this.buttonsDomNode = this._makeButton(this._button, { name: e });
        $("#button123").append(this.buttonsDomNode);
    },
    onAdd: function (t) {
        return this._map = t,
    ...
    _makeButton: function (t, configData) {
        var e = this,
        i = L.DomUtil.create("a", "leaflet-buttons-control-button");
        t.toggleStatus && L.DomUtil.addClass(i, "active");
        var a = L.DomUtil.create("div", "control-icon", i);

        if (configData)
            a.innerHTML = "<span>" + configData.name + "</sapn>";
...
L.PM.Toolbar = L.Class.extend({
    ...
    activeEdit: function (t) {
        this.buttons[t]._triggerClick();
    },
    _defineButtons: function () {
        ...
        i = {
            ...
            afterClick: function () {
                t.map.pm.Draw.active(this.url, "polygon")
            },
            doToggle: !0,
            toggleStatus: !1,
            disableOtherButtons: !0,
        ...
        a = {
            ...
            url: "sm9dV1.0/mapviewer/tool/leaflet/SuperMap.DrawMarker.js",
            onClick: function () { },
            afterClick: function () {
                t.map.pm.Draw.active(this.url, "marker")
            },
            doToggle: !0,
            toggleStatus: !1,
            disableOtherButtons: !0,
        ...
        n = {
            ...
            onClick: function () { },
            url: "sm9dV1.0/mapviewer/tool/leaflet/SuperMap.DrawPolyline.js",
            afterClick: function () {
                t.map.pm.Draw.active(this.url, "polyline")
            },
            doToggle: !0,
            toggleStatus: !1,
            disableOtherButtons: !0,
        ...
        r = {
            ...
            url: "sm9dV1.0/mapviewer/tool/leaflet/SuperMap.DrawCircle.js",
            onClick: function () { },
            afterClick: function () {
                t.map.pm.Draw.active(this.url, "circle")
            },
            doToggle: !0,
            toggleStatus: !1,
            disableOtherButtons: !0,
        ...
        this._addButton("drawMarker", new L.Control.PMButton(a, this.map)),
        this._addButton("drawPolygon", new L.Control.PMButton(i, this.map)),
        this._addButton("drawPolyline", new L.Control.PMButton(n, this.map)),
        this._addButton("drawCircle", new L.Control.PMButton(r, this.map)),
        this._addButton("editPolygon", new L.Control.PMButton(s, this.map))
        //this._addButton("dragPolygon", new L.Control.PMButton(s, this.map)),
        this._addButton("deleteLayer", new L.Control.PMButton(e, this.map))

    },
    _showHideButtons: function () {
        //this.markerButton.addTo(this.map)
        //this.markerButton._triggerClick()
        //this.removeControls();
        //var t = this.getButtons();
        //for (var e in t)  t[e].addTo(this.map)
    },

    edit: function () {
        this._map.pm.Toolbar.activeEdit("editPolygon")
    },

    show: function (e) {
        var tool = this.buttons[e];
        tool.active(e);
    }
});