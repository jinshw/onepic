...
var map, layerT, layerRoad, layerZJRoad, layerYXALL, layer20150913,
    layer20161210, layerYX20162, layerYX201705G216, layerYX201705TWD,
    layerYX201706, layerYX201707, layerYX2017081, layerYX2017082, layerYX201709,
    layerChangeArea, layerJSJD, layerJSJDTWD, areaLayer, ponitLayer,
    drawPoint, mousePosition, vectorLayer, markers;
...
var MAPURL = {
    ...
    YX_2017_05_G216: host + "/iserver/services/map-G216_20171012/rest/maps/G216_201705GJ",
    YX_2017_05_TWD: host + "/iserver/services/map-TWD20171012/rest/maps/TWD201705",
    YX_2017_06: host + "/iserver/services/map-G216_20171012/rest/maps/G216_201706GF2",
    YX_2017_07: host + "/iserver/services/map-G575_20171010/rest/maps/G575_201707",
    YX_2017_08_1: host + "/iserver/services/map-TWD20171012/rest/maps/TWD201708",
    YX_2017_08_2: host + "/iserver/services/map-G575_20171010/rest/maps/G575_201708",
    YX_2017_09: host + "/iserver/services/map-G575_20171010/rest/maps/G575_201709",
    JSJD_URL: host + "/iserver/services/map-jsjd/rest/maps/T500@jsjd",
    JSJD_URL_TWD: host + "/iserver/services/map-jsjdwukui/rest/maps/T500m@jsjdwukui",
    CHANGE_AREA_MAP: host + "/iserver/services/map-G575ChangeArea/rest/maps/G575ChangeArea",
    CHANGE_AREA_DATA: host + "/iserver/services/data-G575ChangeArea/rest/data",
    GF2016_WUYU_URL: host + "/iserver/services/map-G575_20171010/rest/maps/G575_201707",
    GJ2017_WUYU_URL: host + "/iserver/services/map-G575_20171010/rest/maps/G575_201707",
...
function initMap(centerObj) {
    ...
    function addLayer() {
        map.addLayers([
            ...
            layerYX201705G216, layerYX201705TWD, layerYX201706,
            layerYX201707, layerYX2017081, layerYX2017082,
            layerYX201709, layerChangeArea,
            layerRoad, layerZJRoad,
            layerJSJD, layerJSJDTWD, ponitLayer,
            vectorLayer, markers, areaLayer]);
        ...
        if (centerObj == null || typeof (centerObj) == 'undefined'
            || typeof (centerObj.lat) == 'undefined') {
            //显示地图范围9732011.83931, 5440449.31251    85.782, 41.344
            map.setCenter(new SuperMap.LonLat(87.64226, 43.79469), 1);
        } else {
            map.setCenter(new SuperMap.LonLat(centerObj.lat, centerObj.lon), centerObj.level);
        }
