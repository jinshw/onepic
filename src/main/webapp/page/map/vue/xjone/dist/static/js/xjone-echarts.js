...
function initEcharts() {
  xmslChart = echarts.init(document.getElementById("xmslEcharts"));
  // 指定图表的配置项和数据
  var optionTJGNChart = {
    title: {
      text: "项目数量总览",
  ...
  xmtzEcharts = echarts.init(document.getElementById("xmtzEcharts"));
  // 指定图表的配置项和数据
  ...
  // 前期完成情况（全区）
  qqwcAllEcharts = echarts.init(document.getElementById("qqwcAllEcharts"));
  ...
  // 前期完成情况（厅本）
  qqwcTBEcharts = echarts.init(document.getElementById("qqwcTBEcharts"));
  ...
  // 前期完成情况（地州）
  qqwcDZEcharts = echarts.init(document.getElementById("qqwcDZEcharts"));
  ...
  // 项目投资情况（全区）
  xmtzAllEcharts = echarts.init(document.getElementById("xmtzAllEcharts"));
  ...
  // 项目投资情况（厅本）
  xmtzTBEcharts = echarts.init(document.getElementById("xmtzTBEcharts"));
  ...
  // 项目投资情况（地州）
  xmtzDZEcharts = echarts.init(document.getElementById("xmtzDZEcharts"));
  // 模板
  ...
  // 形像进度（全区）
  xxjdAllEcharts = echarts.init(document.getElementById("xxjdAllEcharts"));
  var xxjdAllOption = {
    title: {
      text: "形像进度",
      subtext: "纯属虚构",
  ...
  // 形像进度（厅本）
  xxjdTBEcharts = echarts.init(document.getElementById("xxjdTBEcharts"));
  var xxjdTBOption = {
    title: {
      text: "形像进度",
      subtext: "纯属虚构",
  ...
  // 形像进度（地州）
  xxjdDZEcharts = echarts.init(document.getElementById("xxjdDZEcharts"));
  var xxjdDZOption = {
    title: {
      text: "形像进度",
      subtext: "纯属虚构",
    ...
    eventListeners: {
      processCompleted: function(queryEventArgs) {
        ...
        for (var i = 0; i < queryEventArgs.result.recordsets.length; i++) {
          for (
            var j = 0;
            j < queryEventArgs.result.recordsets[i].features.length;
            j++
          ) {
        ...
        var selectFeatureEchart = new SuperMap.Control.SelectFeature(
          areaLayer,
          {
            callbacks: {
