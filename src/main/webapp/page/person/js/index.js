define([],function(){
	...
	/*获取内容区高度*/
		var bodyH=$(document).height();  //可视区域的高度
		var headH=$('header').height(); //头部的高度
		var navH=$('.body-nav').height();   //底部的高度
		var conH=bodyH-headH-navH;   //内容区的高度
		$('.person').css("height",conH);  //直接赋值给内容区的class名或id
		console.log(conH)
