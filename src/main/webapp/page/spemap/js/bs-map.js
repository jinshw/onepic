...
var map, lineLayer,layerZJRoadR,layerZJRoadY,layerZJRoadG,layerZJRoadH,
    styleLayer = {
        strokeColor: "#304DBE",
        strokeWidth: 2,
...
function initMap() {
    ...
    //初始化图层
    //初始化图层
    layerT = new SuperMap.Layer.TiledDynamicRESTLayer("蓝色地图", MAPURL.URL, {
        transparent: true,
        cacheEnabled: true
    });
    ...
    //     cacheEnabled: true
    // });
    layerZJRoad = new SuperMap.Layer.TiledDynamicRESTLayer("在建道路", MAPURL.ZJ_ROAD, {
        transparent: true,
        cacheEnabled: true
    });
    ...
    //新建三个图层，按照投资额度百分比颜色分层
    layerZJRoadR= new SuperMap.Layer.Vector("红色");
    layerZJRoadY= new SuperMap.Layer.Vector("黄色");
    layerZJRoadG= new SuperMap.Layer.Vector("绿色");

    layerZJRoadH= new SuperMap.Layer.Vector("高亮");
    // map.addLayers([//layerT,
    //     //layerZJRoad,
    //     layerZJRoadR,
    //     layerZJRoadY,
    //     layerZJRoadG
    ...
    function addLayer() {
        map.addLayers([
            layerT,
            layerZJRoad,
            //layerSFZ, layerFWQ,layerYXALL,
            // layerJYZ, layerTCQ, layerBRIDGE,
            // layerZTTGREEN,layerZTTBLUE,layerZTTGRAY,layerZTTBAIDU,
            layerZJRoadR,layerZJRoadY,layerZJRoadG,
            layerZJRoadH,lineLayer
            //, areaLayer
        ]);
