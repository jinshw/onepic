...
$(function () {
    ...
    $(".tools-child-ztt .tools-child-item").click(function () {
        ...
        if (name == "blue") {
            ...
            window.open("/onepic/page/spemap/html/index.html");
        } else if (name == "green") {
            // setLayerVisibilityZTT({"layerZTTGREEN": true});
            window.open("/onepic/page/bigscreen/html/mqi.html");
        } else if (name == "gray") {
            // setLayerVisibilityZTT({"layerZTTGRAY": true});
            window.open("/onepic/page/mapboxgl/ztt/examples/mapboxgl/index.html");
        } else if (name == "baidu") {
